...
@section('contenido')
    ...
    <div class="w-2/5 flex justify-center items-center text-center ms-52">
        <div class="w-fit max-h-full grid grid-cols-2 gap-2 justify-between">
            <div class="flex flex-col items-center col-span-2 md:col-span-1">
                ...
                <button onclick="alert('hola mundo')" class="border rounded-full p-2 px-3 mx-1 transition-colors bg-teal-950 text-gray-50 font-light hover:bg-teal-700">Cambiar imagen</button>
            </div>
    ...
    <section class="container w-3/4 h-full mx-10">
